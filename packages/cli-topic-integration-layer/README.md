...
and inspecting [Integration Layer][docs] extensions.
...
`manage_project` bearer) and derive the Integration Layer's hosts from your login
...
[integration-layer-extensions][repo] repository, which also holds ready-to-edit
templates for each pattern.

[repo]: https://github.com/commercetools/integration-layer-extensions
[ref]: https://github.com/commercetools/integration-layer-extensions/blob/main/docs/cli.md
[authoring]: https://github.com/commercetools/integration-layer-extensions/blob/main/docs/authoring.md

## Develop

This package lives in the [integration-layer-extensions][repo] repo. From the repo
root:
...
[dev]: https://github.com/commercetools/integration-layer-extensions/blob/main/docs/cli.md#developing-the-plugin
