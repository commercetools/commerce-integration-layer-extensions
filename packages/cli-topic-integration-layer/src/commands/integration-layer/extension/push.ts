...
/**
 * Name a build the way its author recognises it: the Commerce Integration Layer's version
...
export default class ExtensionPush extends IntegrationLayerCommand {
  ...
  static override flags = {
    ...
    // by (the Commerce Integration Layer stores an opaque string).
   ...
   * older Commerce Integration Layer, an extension that isn't deployed, a metadata read that
