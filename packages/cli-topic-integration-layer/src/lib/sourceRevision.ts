...
// revision, recorded against the stored bundle by the integration layer.
//
...
// per system: the integration layer treats the value as an OPAQUE string, so
...
/**
 * Longest revision the integration layer stores — it truncates past this. Applied
