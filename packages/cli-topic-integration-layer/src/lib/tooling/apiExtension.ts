...
//
// An API Extension is the commercetools
...
export interface ApiExtensionDefinition {
  // Stable kebab-case id. The Commerce Integration Layer registers the callback with
  // commercetools under a namespaced extension key derived from this.
  key: string;
