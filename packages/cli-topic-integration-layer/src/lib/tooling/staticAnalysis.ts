...
//
// The list below mirrors the endowments the extensions sandbox actually provides —
// that runtime is the source of truth, and this list is updated to follow it. The
// resolver environment offers a restricted set of capabilities, not a full Node
// runtime, so this flags patterns that won't work there before the bundle is
// uploaded. It parses the author's own source files to a
