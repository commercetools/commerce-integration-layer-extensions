...
// subgraph — the same two-subgraph composition the Commerce Integration Layer runs on publish.
//
...
/** The subgraph names the Commerce Integration Layer composes under — matched here so the
...
/**
 * Compose the Commerce Integration Layer + the extension into a supergraph and derive the
